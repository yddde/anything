...
from config import ASSISTANT_NAME, BOT_USERNAME, IMG_1, IMG_2, ALIVE_NAME, OWNER_NAME, UPDATES_CHANNEL
...
@Client.on_message(command(["play", f"play@{BOT_USERNAME}","تشغيل"]) & other_filters)
async def play(c: Client, m: Message):
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(text="لوحه التحكم", callback_data="cbmenu"),
