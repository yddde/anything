...
from config import ASSISTANT_NAME, BOT_USERNAME, IMG_1, IMG_2, UPDATES_CHANNEL, ALIVE_NAME, OWNER_NAME
...
@Client.on_message(command(["vplay", f"vplay@{BOT_USERNAME}","تشغيل_فيديو"]) & other_filters)
